                        ...
                        <tr class="action_area">
                            ...
                            <td>
                                ...
                                <div class="btn_action_area">
                                    <a href="{{ route('admin.editcontact',$contact->id) }}" target="_self">Edit</a>
                                    <a href="#" class="text-danger page_trash" data-id="{{ $contact->id }}">Trash</a>
                                    <a href="{{ route('admin.viewcontact',$contact->id) }}" target="_self">View</a>
                                </div>
                            </td>
                            <td>{{ $contact->subject ? $contact->subject : 'No Subject' }}</td>
                            <td>{{ $contact->message ? $contact->message : 'No Message' }}</td>
                            <td>
                                <div class="publish_badge">Published</div>
                                <div class="date_time">{{ \Carbon\Carbon::parse($contact->updated_at)->format('Y/m/d \a\t g:i a') }}</div>
                            </td>
                        </tr>
                    @endforeach
                @endif
...
<script>
    ...
    $('.page_trash').on('click', function () {
        ...
        var ajax_url = "{{ route('admin.deletecontact', ':id') }}";
