...
class ProductsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.dashboard.products.index', compact('products', 'brands', 'categories', 'subCategories', 'sizes', 'colors', 'productGalleries'));
    }
    ...
    public function create()
    {
        ...
        $colors = Color::where('status', 1)->get();
        $productGalleries = ProductGallery::where('status', 1)->get();
        return view('pages.dashboard.products.create', compact('products', 'brands', 'categories', 'sub_categories', 'sizes', 'colors', 'productGalleries'));
    }
    ...
    public function edit($id)
    {
        ...
        $sizes = Size::where('status', 1)->get();
        $colors = Color::where('status', 1)->get();
        return view('pages.dashboard.products.edit', compact('product','products', 'brands', 'categories', 'subCategories', 'sizes', 'colors', 'product_galleries'));
    }
