            ...
            <div class="col-12 col-md-12">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col text-end">
                        <a href="{{ route('admin.createblog') }}" id="add_blog" name="add_blog" class="btn btn-gray border float-right">Add Blog</a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <tr class="action_area">
                                ...
                                <td>
                                    ...
                                    <div class="btn_action_area">
                                        <a href="{{ route('admin.editblog',$blog->id) }}" target="_self">Edit</a>
                                        <a href="#" class="text-danger page_trash" data-id="{{ $blog->id }}">Trash</a>
                                ...
                                <td>
                                    ...
                                    <div class="date_time">{{ \Carbon\Carbon::parse($blog->updated_at)->format('Y/m/d \a\t g:i a') }}</div>
                                </td>
                            </tr>
                        @endforeach
                    @endif
...
<script>
    ...
    $('.page_trash').on('click', function () {
        ...
        var ajax_url = "{{ route('admin.deleteblog', ':id') }}";
