...
<div class="container mt-5">
    <form action="{{ route('admin.storestudyabroad') }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="row justify-content-center">
                       <div class="col-12 col-md-12 mt-3">
                          ...
                          <button type="button" class="btn btn-link text-danger d-none" name="remove_image2" id="remove_image2">Remove Banner image</button>
                       </div>
                       <div class="col-12 col-md-12 mt-0">
