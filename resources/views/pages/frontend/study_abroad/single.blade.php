...
<div class="about_area pb-25 mt-0">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12">
                <div class="study_abroad pl-0">
...
<div class="about_area pb-25 mt-25">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12">
                <div class="study_abroad pl-0">
                    <div class="text-center w-100"><img src="{{ url('public/assets/frontend/countries/'.$country->image) }}" class="img-fluid border shadow-lg"/></div>
                </div>
            </div>    
        </div>
    </div>
...
<div class="about_area pb-5 mt-50">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-12 col-md-12">
                <div class="study_abroad pl-0">
                    <h3>Explore Your Dream Institutions</h3>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-6 col-md-3">
                  <div class="programme_cat">
                    <a href="{{ $university['link'] }}" class="programme_cat_btn" target="_blank">
                      ...
                      <img src="{{ url('public/assets/frontend/universities/'.$university['image']) }}" alt="{{ $university['name'] }}" class="img-fluid border hvr-grow cursor-pointer programme_cat_img" />
                    </a>
                  </div>
                </div>
              @endforeach
