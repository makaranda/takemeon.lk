...
<div class="container mt-5">
    ...
    @endif
    <form action="{{ route('admin.storeaccording') }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="row justify-content-center">
                       <div class="col-12 col-md-12">
                          <label class="fw-bold">Add Topic</label>
                          <input type="text" class="form-control mt-3" placeholder="Add Topic" name="topic" id="topic" value="{{ old('topic') }}">
                          @error('topic')
                            <div class="text-danger">{{ $message }}</div>
                          @enderror
                       </div>
                       <div class="col-12 col-md-12 mt-3">
                          <label class="fw-bold">Add Sub Topic</label>
                          <input type="text" class="form-control mt-3" placeholder="Add Sub Topic" name="sub_topic" id="sub_topic" value="{{ old('sub_topic') }}">
                          @error('sub_topic')
                            <div class="text-danger">{{ $message }}</div>
                          @enderror
                       </div>
                  ...
                  <div class="card-body">
                    <div class="row justify-content-center">
                       ...
                       <div class="col-12 col-md-12 mt-3">
                          ...
                          <input type="number" class="form-control mt-3" max="100" min="1" placeholder="Section" value="{{ old('section', 1) }}" name="section" id="section">
                          @error('section')
                            <div class="text-danger">{{ $message }}</div>
                          @enderror
                       </div>
