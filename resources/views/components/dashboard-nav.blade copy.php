    ...
    <div class="container-fluid">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-md-block">
            <a href="{{ route('home') }}" target="_new" class="nav-link">Home</a></li>
    ...
    <div class="sidebar-wrapper">
      <nav class="mt-2">
          <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item {{ request()->routeIs('admin.mainslider', 'admin.editmainslider', 'admin.settings') ? 'menu-open' : '' }}">
              ...
              {{-- <li class="nav-item {{ request()->routeIs('admin.programmes', 'admin.createprogramme', 'admin.editprogramme','admin.accordings', 'admin.createaccording', 'admin.editaccording') ? 'menu-open' : '' }}">
                  <a href="#" class="nav-link">
                      <i class="nav-icon bi bi-pencil-square"></i>
                      <p>
                          Programmes
                  ...
                  <ul class="nav nav-treeview">
                      <li class="nav-item">
                          <a href="{{ route('admin.programmes') }}" class="nav-link {{ request()->routeIs('admin.programmes', 'admin.createprogramme', 'admin.editprogramme') ? 'active' : '' }}">
                              <i class="nav-icon bi bi-circle"></i>
                              <p>Programmes List</p>
                          </a>
                      </li>
                      <li class="nav-item">
                          <a href="{{ route('admin.accordings') }}" class="nav-link {{ request()->routeIs('admin.accordings', 'admin.createaccording', 'admin.editaccording') ? 'active' : '' }}">
                              <i class="nav-icon bi bi-circle"></i>
                              <p>According List</p>
                          </a>
                      </li>
                       <li class="nav-item">
                          <a href="{{ route('admin.createprogramme') }}" class="nav-link {{ request()->routeIs('admin.createprogramme') ? 'active' : '' }}">
                              <i class="nav-icon bi bi-circle"></i>
                              <p>Add Programme</p>
                          </a>
                      </li>
