...
<div class="container mt-5">
    ...
    @endif
  <div class="card">
    <div class="card-header">Universities Content</div>
     <div class="card-body">
            ...
            <div class="col-12 col-md-12">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col text-end">
                        <a href="{{ route('admin.createpage') }}" id="add_blog" name="add_blog" class="btn btn-gray border float-right">Add Page</a>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <tr class="action_area">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn_action_area">
                                            <a href="{{ route('admin.editstudyabroad',$page->id) }}" target="_self">Edit</a>
                                            <a href="#" class="text-danger page_trash" data-id="{{ $page->id }}">Trash</a>
                                            <a href="{{ route('frontend.studyabroad.university',['slug' => $page->slug]) }}" target="_blank">View</a>
                                        </div>
                                    </td>
...
<script>
    ...
    $('.page_trash').on('click', function () {
        ...
        var ajax_url = "{{ route('admin.deletestudyabroad', ':id') }}";
        ajax_url = ajax_url.replace(':id', page_id);

        // Call the AlertModelDetails function
        AlertModelDetails(
            'Confirm Deletion',
            'Are you sure you want to delete this Study Abroad Page..??',
            'Cancel',
            'Delete',
            page_id,
            ajax_url,
