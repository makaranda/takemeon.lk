...
<div class="container mt-5">
    <form action="{{ route('admin.updatecustomer',$user->id) }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="row justify-content-center">
                       <div class="col-12 col-md-12">
                          ...
                          <input type="text" class="form-control mt-3" placeholder="Name" name="name" id="name" value="{{ old('name',$user->name) }}">
                          @error('title')
                       ...
                       <div class="col-12 col-md-12 mt-3">
                          ...
                          <input type="text" class="form-control mt-3" placeholder="Email" name="email" id="email" value="{{ old('email',$user->email) }}">
                          @error('email')
                            <div class="text-danger">{{ $message }}</div>
                          @enderror
                       </div>
                       ...
                       <div class="col-12 mt-3">
                            ...
                            <input type="number" class="form-control mt-2" name="phone" placeholder="Phone" value="{{ old('phone',$user->phone) }}">
                            @error('phone') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>
                       <div class="col-12 col-md-12 mt-3">
                          <label class="fw-bold">Username</label>
                          <input type="text" class="form-control mt-3" placeholder="Username" name="username" id="username" value="{{ old('username',$user->username) }}">
                          @error('title')
                            <div class="text-danger">{{ $message }}</div>
                          @enderror
                       </div>
                       ...
                       <div class="col-12 mt-3">
                            ...
                            <input type="password" class="form-control mt-2" name="password" placeholder="Password" autocomplete="new-password">
                            @error('password') <div class="text-danger">{{ $message }}</div> @enderror
                        </div>

                        <!-- Confirm Password -->
                        <div class="col-12 mt-3">
                            <label class="fw-bold text-danger">New Confirm Password</label>
