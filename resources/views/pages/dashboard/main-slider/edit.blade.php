...
<div class="container mt-5">
    ...
    @endif
    <form action="{{ route('admin.updatemainslider', $slider->id) }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" class="form-control mt-3" placeholder="Top Text" name="top_text" id="top_text" value="{{ old('top_text', $slider->icon) }}">
                                @error('top_text')
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" class="form-control mt-3" placeholder="Heading" name="heading" id="heading" value="{{ old('heading', $slider->heading) }}">
                                @error('heading')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-12 col-md-12 mt-3">
                                ...
                                <textarea class="form-control mt-3" placeholder="Sub Heading" name="description" id="description">{{ old('description', $slider->description) }}</textarea>
                                @error('sub_heading')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 mt-3">
                                ...
                                @if($slider->banner)
                                    <img src="{{ asset('public/assets/frontend/img/sliders/' . $slider->banner) }}" class="img-fluid" id="image_show"/>
                                    <p class="btn mb-0" id="img_description">Click the image to edit or update</p>
                                    <button type="button" class="btn btn-link text-danger" name="remove_image" id="remove_image">Remove Slider image</button>
                                @else
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 mt-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch" name="switch_publish" id="switch_publish" {{ old('switch_publish', $slider->switch) ? 'checked' : '' }}/>
