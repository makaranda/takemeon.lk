...
<div class="container mt-5">
    <form action="{{ route('admin.updateevent', $page->id) }}" id="formSubmit" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                           ...
                           <div class="col-12 col-md-12 mt-3">
                              ...
                              @for ($year = date('Y'); $year >= 2000; $year--)
                                    <option value="{{ $year }}" {{ old('year') == $year || $page->year == $year ? 'selected' : '' }}>{{ $year }}</option>
                              @endfor
                                </select>
                              @error('year')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12 col-md-12 mt-3">
                                ...
                                @if($page->banner_image)
                                    <img src="{{ asset('public/assets/frontend/img/banner/' . $page->banner_image) }}" class="img-fluid" id="image_show2"/>
